# -*- coding: utf-8 -*-
"""Append article #170 to data/articles_en.json"""
import json, re

DRAFT = '_article_170_draft.txt'
...
date = meta['DATE']
month_map = {'01': 'January', '02': 'February', '03': 'March', '04': 'April', '05': 'May',
             '06': 'June', '07': 'July', '08': 'August', '09': 'September', '10': 'October',
             '11': 'November', '12': 'December'}
date_full = f"{month_map[date[5:7]]} {int(date[8:10])}, {date[:4]}"
