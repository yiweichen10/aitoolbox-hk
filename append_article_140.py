...
DRAFT = os.path.join(BASE, '_article_140_draft.txt')
...
slug = "best-ai-product-analytics-tools-2026-amplitude-vs-mixpanel-vs-posthog-vs-heap"
...
print('PK count (ai product analytics tools 2026):', content.lower().count('ai product analytics tools 2026'))
