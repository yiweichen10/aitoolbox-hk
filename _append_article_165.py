# -*- coding: utf-8 -*-
"""Append article #165 to data/articles_en.json (pit #8: extract body after \\n---\\n)."""
import json, shutil

shutil.copy('data/articles_en.json', 'data/articles_en.json.20260918.bak')
...
print('pk:', last['content'].count('AI accounting software'))
