# -*- coding: utf-8 -*-
"""Append article #164 to data/articles_en.json (pit #8: extract body after \\n---\\n)."""
import json, shutil

shutil.copy('data/articles_en.json', 'data/articles_en.json.20260917.bak')

raw = open('_article_164_draft.txt', encoding='utf-8').read()
parts = raw.split('\n---\n', 1)
meta = {}
...
print('pk:', last['content'].count('AI UGC ad generators'))
